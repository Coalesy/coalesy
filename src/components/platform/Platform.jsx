...
const Platform = () => {
  return (
    <div className="px-56 bg-[#10091B]">
      <div>
        <h1 className="text-[40px] font-semibold w-[357px] lg:leading-[44px] leading-[33px]">
          A Web3 Platform for Everyone
        </h1>
        <p className="w-[442px] opacity-70 py-6">
          Explore the Coalesy platform, discover upcoming events, and join a
          community.
        </p>
      </div>

      <div className="bg-[url(/gradient-bg.svg)] bg-cover bg-center bg-blend-screen py-10">
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
          <div className="bg-[#443448] p-5 rounded-md">
            <Image
              src="/main-arrow.svg"
              alt="Next.js Logo"
              width={41}
              height={38}
            />
            <h2 className="text-[20px] leading-[27px] font-600 py-[20px]">
