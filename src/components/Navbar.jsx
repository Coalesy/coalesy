    ...
    return (
        <div className="container flex justify-between items-center py-2 bg-[#0A0511]">
            ...
            <div className="flex gap-10">
                <div className='bg-[#443448] rounded-[5px] py-3  px-4 w-[280px] flex items-center gap-2'>
                ...
                {/* <div className='bg-[#443448] px-3 rounded-[5px] py-2 flex items-center gap-4'>
                    <button className="text[14px] bg-[#FF5B96] py-1 tracking-[-2%] font-semibold px-5 rounded-[3px]">All chains</button>
            ...
            <button className="text[15px] :hover:bg-[#FF93FF] bg-[#FF5B96] tracking-[-2%] py-3 px-10 rounded-[5px] font-semibold">Connect wallet</button>
        </div>
    );
}
