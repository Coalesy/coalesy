                        ...
                        <div
                            ...
                            <div className='absolute bottom-6 left-6 right-0 p-4 flex items-center justify-between z-10'>
                                <div className='flex flex-col gap-4'>
                                    <img src={d.logo} className='h-10 w-10 rounded-full mr-2' alt={d.name} />
                                    <div className='flex flex-col gap-2'>
                                        <h2 className='text-white text-[25px] tracking-[-1px] font-semibold'>{d.name}</h2>
                                        <div className='flex items-center gap-4'>
                                            <p className='text-white text-[14px] tracking-[-0.5px] text-opacity-70'>Price: <span className='text-white font-[700]'>{d.price}</span></p>
                                            <p className='text-white text-[14px] tracking-[-0.5px] text-opacity-70'>Items: <span className='text-white font-[700]'>{d.items}</span></p>
                                            <p className='text-white text-[14px] tracking-[-0.5px] text-opacity-70'>Minted: <span className='text-white font-[700]'>{d.minted}</span></p>
                                        </div>
                                        <div className='text-white bg-[#0A0511] w-[184px] h-[41px] flex gap-2 items-center justify-center rounded-md text-[14px] tracking-[-0.5px] text-opacity-70'>
                                            ...
                                            <span className='text-white font-[700]'>
                                                {" "}
                                                <Countdown className='text-white font-[700]' date={Date.now() + parseInt(d.countdown.split(' ')[0], 10) * 24 * 60 * 60 * 1000} renderer={renderer} />
                                            </span>
                                        </div>
                                    </div>
                                </div>
